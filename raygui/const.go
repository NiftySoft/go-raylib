...
const (
	// RAYGUI_VERSION as defined in src/raygui.h:135
	RAYGUI_VERSION = "2.9-dev"
	// RAYGUIDEF as defined in src/raygui.h:156
	RAYGUIDEF = 0
	// NUM_CONTROLS as defined in src/raygui.h:178
	NUM_CONTROLS = 16
	// NUM_PROPS_DEFAULT as defined in src/raygui.h:179
	NUM_PROPS_DEFAULT = 16
	// NUM_PROPS_EXTENDED as defined in src/raygui.h:180
	NUM_PROPS_EXTENDED = 8
	// TEXTEDIT_CURSOR_BLINK_FRAMES as defined in src/raygui.h:182
	TEXTEDIT_CURSOR_BLINK_FRAMES = 20
	// DEFAULT_BATCH_BUFFER_ELEMENTS as defined in src/rlgl.h:135
	DEFAULT_BATCH_BUFFER_ELEMENTS = 8192
	// DEFAULT_BATCH_BUFFERS as defined in src/rlgl.h:145
	DEFAULT_BATCH_BUFFERS = 1
	// DEFAULT_BATCH_DRAWCALLS as defined in src/rlgl.h:148
...
// GuiControlState as declared in src/raygui.h:266
type GuiControlState int32

// GuiControlState enumeration from src/raygui.h:266
const (
...
// GuiTextAlignment as declared in src/raygui.h:273
type GuiTextAlignment int32

// GuiTextAlignment enumeration from src/raygui.h:273
const (
...
// GuiControl as declared in src/raygui.h:293
type GuiControl int32

// GuiControl enumeration from src/raygui.h:293
const (
...
// GuiControlProperty as declared in src/raygui.h:313
type GuiControlProperty int32

// GuiControlProperty enumeration from src/raygui.h:313
const (
...
// GuiDefaultProperty as declared in src/raygui.h:324
type GuiDefaultProperty int32

// GuiDefaultProperty enumeration from src/raygui.h:324
const (
...
// GuiToggleProperty as declared in src/raygui.h:335
type GuiToggleProperty int32

// GuiToggleProperty enumeration from src/raygui.h:335
const (
	GROUP_PADDING GuiToggleProperty = 16
)

// GuiSliderProperty as declared in src/raygui.h:341
type GuiSliderProperty int32

// GuiSliderProperty enumeration from src/raygui.h:341
const (
	SLIDER_WIDTH   GuiSliderProperty = 16
	SLIDER_PADDING GuiSliderProperty = 17
)

// GuiProgressBarProperty as declared in src/raygui.h:346
type GuiProgressBarProperty int32

// GuiProgressBarProperty enumeration from src/raygui.h:346
const (
	PROGRESS_PADDING GuiProgressBarProperty = 16
)

// GuiCheckBoxProperty as declared in src/raygui.h:351
type GuiCheckBoxProperty int32

// GuiCheckBoxProperty enumeration from src/raygui.h:351
const (
	CHECK_PADDING GuiCheckBoxProperty = 16
)

// GuiComboBoxProperty as declared in src/raygui.h:357
type GuiComboBoxProperty int32

// GuiComboBoxProperty enumeration from src/raygui.h:357
const (
	COMBO_BUTTON_WIDTH   GuiComboBoxProperty = 16
	COMBO_BUTTON_PADDING GuiComboBoxProperty = 17
)

// GuiDropdownBoxProperty as declared in src/raygui.h:363
type GuiDropdownBoxProperty int32

// GuiDropdownBoxProperty enumeration from src/raygui.h:363
const (
	ARROW_PADDING          GuiDropdownBoxProperty = 16
	DROPDOWN_ITEMS_PADDING GuiDropdownBoxProperty = 17
)

// GuiTextBoxProperty as declared in src/raygui.h:371
type GuiTextBoxProperty int32

// GuiTextBoxProperty enumeration from src/raygui.h:371
const (
...
// GuiSpinnerProperty as declared in src/raygui.h:377
type GuiSpinnerProperty int32

// GuiSpinnerProperty enumeration from src/raygui.h:377
const (
	SPIN_BUTTON_WIDTH   GuiSpinnerProperty = 16
	SPIN_BUTTON_PADDING GuiSpinnerProperty = 17
)

// GuiScrollBarProperty as declared in src/raygui.h:387
type GuiScrollBarProperty int32

// GuiScrollBarProperty enumeration from src/raygui.h:387
const (
...
// GuiScrollBarSide as declared in src/raygui.h:393
type GuiScrollBarSide int32

// GuiScrollBarSide enumeration from src/raygui.h:393
const (
	SCROLLBAR_LEFT_SIDE  GuiScrollBarSide = iota
	SCROLLBAR_RIGHT_SIDE GuiScrollBarSide = 1
)

// GuiListViewProperty as declared in src/raygui.h:401
type GuiListViewProperty int32

// GuiListViewProperty enumeration from src/raygui.h:401
const (
...
// GuiColorPickerProperty as declared in src/raygui.h:410
type GuiColorPickerProperty int32

// GuiColorPickerProperty enumeration from src/raygui.h:410
const (
