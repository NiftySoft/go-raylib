...
// allocPhysicsBodyDataMemory allocates memory for type C.PhysicsBody in C.
...
const sizeOfPhysicsBodyDataValue = unsafe.Sizeof([1]C.PhysicsBody{})
...
func (x *gPhysicsShape) passRef() (*C.PhysicsShape, *cgoAllocMap) {
	...
	ref4c540f1a.body, cbody_allocs = x.gBody.passValue()
...
func (x *gPhysicsManifoldData) passRef() (*C.PhysicsManifoldData, *cgoAllocMap) {
	...
	ref10b92967.bodyA, cbodyA_allocs = x.gBodyA.passValue()
	allocs10b92967.Borrow(cbodyA_allocs)
	x.gBodyA = *new(gPhysicsBodyData)

	var cbodyB_allocs *cgoAllocMap
	ref10b92967.bodyB, cbodyB_allocs = x.gBodyB.passValue()
