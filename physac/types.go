...
// PhysicsBodyData as declared in src/physac.h:128
type gPhysicsBodyData struct {
	...
	refbd69ac32      *C.PhysicsBody
	allocsbd69ac32   interface{}
}
...
// Vector2 as declared in src/physac.h:135
...
// Matrix2x2 as declared in src/physac.h:144
...
// PhysicsVertexData as declared in src/physac.h:150
type gPhysicsVertexData struct {
	gVertexCount   uint32
	gPositions     [24]gVector2
	gNormals       [24]gVector2
	ref7752f88a    *C.PhysicsVertexData
	allocs7752f88a interface{}
}
type PhysicsVertexData struct {
	VertexCount uint32
	Positions   [24]Vector2
	Normals     [24]Vector2
}

// PhysicsShape as declared in src/physac.h:159
type gPhysicsShape struct {
	gType          PhysicsShapeType
	gBody          gPhysicsBodyData
	gVertexData    gPhysicsVertexData
	gRadius        float32
...
// PhysicsManifoldData as declared in src/physac.h:196
