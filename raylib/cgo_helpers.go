...
func NewVrStereoConfig(cLeftLensCenter [2]float32, cRightLensCenter [2]float32, cLeftScreenCenter [2]float32, cRightScreenCenter [2]float32, cScale [2]float32, cScaleIn [2]float32) VrStereoConfig {
	obj := *new(gVrStereoConfig)
...
func AllocVrStereoConfig(cLeftLensCenter [2]float32, cRightLensCenter [2]float32, cLeftScreenCenter [2]float32, cRightScreenCenter [2]float32, cScale [2]float32, cScaleIn [2]float32) (*VrStereoConfig, *cgoAllocMap) {
	obj := *new(gVrStereoConfig)
	obj.gLeftLensCenter = cLeftLensCenter
	obj.gRightLensCenter = cRightLensCenter
	obj.gLeftScreenCenter = cLeftScreenCenter
